    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="text-center col-md-5">
                ...
                <hr>
                <form action="/promoter/{{Auth::user()->slug}}/info" method="POST">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    <label for="">Do you want your email private?</label>
                    <br>
                        yes <input type="radio" value="yes" @if(Auth::user()->email_hidden == 'yes') checked @endif name="email_hidden">   
                        no <input type="radio" value="no" @if(Auth::user()->email_hidden != 'yes') checked @endif name="email_hidden">
                    <div class="col-md-12">
                        <div class="col-md-6">
            ...
            <div class="col-md-5 col-md-offset-2 text-center">
                ...
                <hr>
                <form action="/promoter/{{Auth::user()->slug}}/bio" method="POST">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
