    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body half-height banner" style=" background: url('{{url('storage/bands/banner/' . Auth::user()->banner_image )}}');">
                    <div class="" style="width: 100%; height: 100%; position: relative;  ">
                        
                        <div style="position: relative; top: 0; left: 0; height: 100%;">
                            
                            
                            <div class="profile-image col-md-4" style="padding: 0; position: relative; margin-top: 157px; background: url('{{url('storage/bands/avatar/' . Auth::user()->profile_image )}}'); height: 20vh;">
