    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register <div class="pull-right">Already a member? <a href="/promoter/login">Sign in!</a></div></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/promoter/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('agency_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="agency_name" type="text" class="form-control" name="agency_name" value="{{ old('agency_name') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('genre') ? ' has-error' : '' }}">
                            <label for="genre" class="col-md-4 control-label">Genres</label>

                            <div class="col-md-6">
                                <input id="genre" type="text" class="form-control" name="genre" value="{{ old('genre') }}" autofocus>
